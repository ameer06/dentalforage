...
export const SITE_CONFIG = {
  ...
  // Google Maps
  googleMapsUrl: 'https://maps.google.com/maps?q=Sri+Chandhanam+Dental+clinic+vallioor+Implant+and+Braces+Center+Branch+_2&t=&z=17&ie=UTF8&iwloc=&output=embed',
